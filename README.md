...
I'm working on [Arima ESG](https://www.linkedin.com/company/arima-esgtech/posts/?feedView=all), an agricultural engineering platform that allows technicians and investors to control what, when and where everything is happening on the field. It features a 3D digital twin that displays real-time information about the multiple activities taking place, including locations and external irrigation provider integrations.

At the same time, back in my home server, I'm developing a [Nakama](https://heroiclabs.com/nakama/) based gaming application that will allow me to create online multiplayer games. This framework uses Go to work.

## Video games

### [Ghostly Room Service](https://blueharrier.itch.io/ghostly-room-service)

![Ghostly Room Service cover concept art](./img/grs01.png)
...
![Mock screenshot of the game](./img/grs02.png)
...
### [Downhell](https://blueharrier.itch.io/downhell)

![Downhell cover](./img/dh01.png)

Third place on [Revival Jam 2025](https://itch.io/jam/revival-jam-2025). A 2D narrative game about a friend group that gets lost in the forest and has to escape from a monster, with an interesting twist at the end.

![Downhell gameplay screenshot](./img/dh02.png)
...
![Rust renderer with OpenGL](./img/rogl.png)
...
In 2023, I designed and made a kit of DIY [SlimeVR](https://slimevr.dev/) controllers. These controllers had a custom made board on which components where attached, and own design 3D printed cases.

![Fully assembled SlimeVRs](./img/svr01.png)

I made a fully integrated redesign, but as it required smaller components, it was never made. It was a 33% smaller design.

![SlimeHarrier 2.0, never built](./img/svr02.png)
...
* 📓 [LinkedIn](https://www.linkedin.com/in/daniel-p-2214943b9/)
* 🐦 [Twitter](https://twitter.com/BlueHarrierDev)
* 🎮 [Itch.io](https://blueharrier.itch.io/)
* 💰 [Patreon](https://patreon.com/blueharrier?utm_medium=unknown&utm_source=join_link&utm_campaign=creatorshare_creator&utm_content=copyLink)
